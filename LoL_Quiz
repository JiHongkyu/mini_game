...
fetch("https://ddragon.leagueoflegends.com/cdn/9.19.1/data/ko_KR/champion.json").then(response => response.json()).then(data => {
...
function randomWord() {
    ...
    fetch(`https://ddragon.leagueoflegends.com/cdn/9.19.1/img/champion/${champion[random]}.png`).then(response => img.src = response.url);
